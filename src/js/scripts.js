		...
		function tradEn(toTrad) {
			...
			switch (english) {
				...
				case 'pourcentag.es est une expérience neuomorphique, un mariage d’interfaces du passé et du présent.':
					traduit = "pourcentag.es is a <a href='https://dribbble.com/tags/neomorphism' target='_blank'>neomorphic</a> experiment, a combination of interfaces from the <a href='https://en.wikipedia.org/wiki/Skeuomorph' target='_blank'>past</a> and the <a href='https://en.wikipedia.org/wiki/Flat_design' target='_blank'>present</a>.";
					break;
